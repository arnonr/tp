...
use app\models\PortfolioYearSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;
use yii\filters\AccessControl;

class PortfolioYearController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $searchModel = new PortfolioYearSearch();
    ...
    {
        if (($model = PortfolioYear::findOne($id)) !== null) {
            return $model;
        }
