...
use app\models\TgdePortfolioYearSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;
use yii\filters\AccessControl;

class TgdePortfolioYearController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $searchModel = new TgdePortfolioYearSearch();
    ...
    {
        if (($model = TgdePortfolioYear::findOne($id)) !== null) {
            return $model;
        }
