...
<div class="course-form m-t-20">
    <?php $form = ActiveForm::begin([
        ...
        <div class="form-group field-news-n_img required">
            <label class="control-label" for="course-c_img">รูปภาพปก</label>
            <?= Yii::$app->mpic->picform($model,'c_img','course','Course'); ?>
        </div>

         <?= $form->field($model, 'c_detail')->textArea(['maxlength' => true]) ?>
